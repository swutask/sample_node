...
inputs = {
  log_group_name         = "email-notification-consumer-production"
  app_name               = "email-notification-consumer-production"
  node_env               = "production"
...
dependencies {
  paths = ["../ecs", "../ecr",  "../ec2-profile", "../ecs-capacity-provider", "../sg-ec2", "../vpc" ]
}
